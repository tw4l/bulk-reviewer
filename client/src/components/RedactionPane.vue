<template>
  ...
  <div v-else>
    ...
    <div style="margin-bottom: 15px;">
      ...
      <p><strong>Unconfirmed/dismissed:</strong> {{ featuresClearedCount }} <span v-if="featuresClearedCount !== 0"><button class="button is-small" @click="toggleShowDismissed" v-tooltip="'Review unconfirmed and dismissed results'">View</button></span></p>
    </div>
    <!-- Action buttons -->
    <div class="buttons">
